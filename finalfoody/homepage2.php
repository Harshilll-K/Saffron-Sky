...
if (isset($_SESSION['email'])) {
    ...
    if ($row) {
        $userName = $row['name']; // Assuming there's a name column in the users table
    }
}
?>
    ...
    <body class="bg-gray-100">
        ...
        <header class="navbar bg-white bg-opacity-50">
            <div class="nav-links">
                ...
                <div class="flex flex-col items-center flex-grow">
                    <img src="logo.png" alt="Saffron Sky Logo" class="h-16 mx-auto">
                </div>
                ...
                <div class="flex space-x-6 text-lg font-semibold items-center">
                    ...
                    <?php endif; ?>
                    <a href="./cart_page.php" class=" hover:text-orange-500 text-xl flex items-center">
                        🛒
                    </a>
                </div>
            </div>
        ...
        <main>
            ...
            <section class="meal-box-slider">
                <style>
                    .user-profile img {
                        ...
                        /* Optional: red border like button outline */
                        cursor: pointer;
                    }
                ...
                <div class="slider-container">
                    ...
                    <div class="slider">
                        ...
                        <div class="slide">
                            <div class="meal-box">
                                ...
                                <div class="meal-content">
                                    ...
                                    <p style="color: #fff; margin-top: 10px;">Tender chicken pieces in rich, creamy tomato
                                        gravy</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="slide">
                            <div class="meal-box">
                                <div class="meal-image">
                                    <img src="images/Paneer Tikka Masala.jpg" alt="Paneer Tikka Masala">
                                </div>
                                <div class="meal-content">
                                    <span class="meal-type">Veg</span>
                                    <h2 class="meal-title">Paneer Tikka</h2>
                                    <div class="meal-price">
                                        <span class="original-price">₹280</span>
                                        <span class="discounted-price">₹249</span>
                                    </div>
                                    <p style="color: #fff; margin-top: 10px;">Grilled cottage cheese with spicy marinade</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="slide">
                            <div class="meal-box">
                                ...
                                <div class="meal-content">
                                    <span class="meal-type">Non Veg</span>
                                    <h2 class="meal-title">Chicken Biryani</h2>
                                    <div class="meal-price">
                                        <span class="original-price">₹320</span>
                                        <span class="discounted-price">₹279</span>
                                    </div>
                                    <p style="color: #fff; margin-top: 10px;">Fragrant rice cooked with tender chicken and
                                        aromatic spices</p>
                                </div>
                            </div>
                        </div>
            ...
            <section class="text-animation-section">
                <style>
                    ...
                    .row-1 .animated-text:nth-child(1) {
                        animation-delay: 0s;
                    }

                    .row-1 .animated-text:nth-child(2) {
                        animation-delay: 0.5s;
                    }

                    .row-1 .animated-text:nth-child(3) {
                        animation-delay: 1s;
                    }

                    .row-1 .animated-text:nth-child(4) {
                        animation-delay: 1.5s;
                    }

                    .row-2 .animated-text:nth-child(1) {
                        animation-delay: 2s;
                    }

                    .row-2 .animated-text:nth-child:nth-child(2) {
                        animation-delay: 2.5s;
                    }

                    .row-2 .animated-text:nth-child(3) {
                        animation-delay: 3s;
                    }

                    .row-2 .animated-text:nth-child(4) {
                        animation-delay: 3.5s;
                    }

                    .row-3 .animated-text:nth-child(1) {
                        animation-delay: 4s;
                    }

                    .row-3 .animated-text:nth-child(2) {
                        animation-delay: 4.5s;
                    }

                    .row-3 .animated-text:nth-child(3) {
                        animation-delay: 5s;
                    }

                    .row-3 .animated-text:nth-child(4) {
                ...
                <div class="special-menu-grid">
                    <div class="special-menu-item">
                        ...
                        <div class="special-menu-content">
                            ...
                            <button class="cart-button"
                                onclick="addToCart('Butter Chicken', 299, 'nonv/butter chicken.webp')">Add to
                                Cart</button>
                        </div>
                    </div>
                    ...
                    <div class="special-menu-item">
                        ...
                        <div class="special-menu-content">
                            ...
                            <button class="cart-button"
                                onclick="addToCart('Paneer Tikka', 249, 'images/Paneer Tikka Masala.jpg')">Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div class="special-menu-item">
                        ...
                        <div class="special-menu-content">
                            ...
                            <button class="cart-button"
                                onclick="addToCart('Chicken Biryani', 279, 'images/chicken-biryani-recipe.jpg')">Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div class="special-menu-item">
                        ...
                        <div class="special-menu-content">
                            ...
                            <button class="cart-button"
                                onclick="addToCart('Dal Makhani', 199, 'veg main course/Dal Makhani.webp')">Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div class="special-menu-item">
                        ...
                        <div class="special-menu-content">
                            ...
                            <button class="cart-button"
                                onclick="addToCart('Kaju Masala', 249, 'images/Kaju Masala.jpeg')">Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div class="special-menu-item">
                        ...
                        <div class="special-menu-content">
                            ...
                            <button class="cart-button"
                                onclick="addToCart('Gulab Jamun', 129, 'desert images/gulab jamun.webp')">Add to Cart</button>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div
                            ...
                            <div class="flex justify-center mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"
                                    fill="none" stroke="#fb6107" stroke-width="2" stroke-linecap="round"
                    ...
                    <div class="row-2-cols">
                        <div class="col-half">
                            <div class="testimonials_customers_box">
                                ...
                                <p>""This app is a game-changer! The user interface is smooth, and the real-time tracking is
                                    super accurate.
                                    My orders always arrive on time, and I love the variety of restaurants available. Plus,
                        ...
                        <div class="col-half">
                            <div class="testimonials_customers_box">
                                ...
                                <p>Ordered a cheeseburger with fries, and it was absolutely delicious! The food arrived hot,
                                    fresh, and well-packaged. The burger was juicy, and the fries were crispy—just like they
                                    would be at the restaurant. Definitely ordering again</p>
                                <div class="customer-info">
                                    <h3>Naman Kadam</h3>
                                </div>
                            </div>
                        ...
                        <div class="col-half">
                            <div class="testimonials_customers_box">
                                ...
                                <p>"The app is easy to use, but sometimes delivery times can be unpredictable. While most
                                    orders arrive on time, a few have been delayed without proper updates. Customer support
                                    could be more responsive, but overall, it gets the job done."</p>
                                <div class="customer-info">
                                    <h3>Ayush Agarwal</h3>
                                </div>
                            </div>
                        ...
                        <div class="col-half">
                            <div class="testimonials_customers_box">
                                ...
                                <p>""The pizza I ordered was decent, but it arrived lukewarm. The taste was good, but I
                                    expected better packaging to keep it hot. Would consider ordering again, but only if
                                    they improve delivery speed.""</p>
                                <div class="customer-info">
        ...
        <script>
            ...
            const foodCategories = {
                ...
                'non-vegetarian': ['Butter Chicken', 'Chicken Biryani', 'Mutton Curry', 'Fish Curry'],
                'starters': ['Paneer Tikka', 'Chicken Tikka', 'Veg Pakora', 'Spring Roll'],
                'desserts': ['Gulab Jamun', 'Rasmalai', 'Kheer', 'Gajar Ka Halwa'],
                'drinks': ['Cold Coffee', 'Mango Lassi', 'Fresh Lime Soda', 'Masala Chai']
            };
            ...
            function toggleChat() {
                ...
                if (chatOpen && document.getElementById('chat-messages').children.length === 0) {
                    addBotMessage("Hello! 👋 I'm your food recommendation assistant. What kind of food are you in the mood for today?");
            ...
            function processUserInput(input) {
                ...
                if (input.includes('vegetarian')) {
                    addBotMessage("Great choice! Here are some delicious vegetarian options:");
                    const recommendations = foodCategories.vegetarian;
                    addBotMessage(recommendations.join(', '));
                    showSuggestions(['Show Menu', 'Other Options', 'Place Order']);
                }
                else if (input.includes('non-vegetarian') || input.includes('non vegetarian')) {
                    addBotMessage("Perfect! Here are some mouth-watering non-vegetarian dishes:");
                    const recommendations = foodCategories['non-vegetarian'];
                    addBotMessage(recommendations.join(', '));
                    showSuggestions(['Show Menu', 'Other Options', 'Place Order']);
                }
                else if (input.includes('starter')) {
                    addBotMessage("Here are some amazing starters to begin with:");
                    const recommendations = foodCategories.starters;
                    addBotMessage(recommendations.join(', '));
                    showSuggestions(['Show Menu', 'Other Options', 'Place Order']);
                }
                else if (input.includes('dessert') || input.includes('sweet')) {
                    addBotMessage("How about these delightful desserts?");
                    const recommendations = foodCategories.desserts;
                    addBotMessage(recommendations.join(', '));
                    showSuggestions(['Show Menu', 'Other Options', 'Place Order']);
                }
                else if (input.includes('drink') || input.includes('beverage')) {
                    addBotMessage("Here are some refreshing drinks:");
                    const recommendations = foodCategories.drinks;
                    addBotMessage(recommendations.join(', '));
                    showSuggestions(['Show Menu', 'Other Options', 'Place Order']);
                }
                else if (input.includes('show menu')) {
                    addBotMessage("You can view our full menu here:");
                    window.location.href = './menu.html';
                }
                else if (input.includes('place order')) {
                    addBotMessage("Great! Let's get your order started.");
                    window.location.href = './menu.html';
                }
                else if (input.includes('other options')) {
                    addBotMessage("What type of food would you like to explore?");
                    showSuggestions(['Vegetarian', 'Non-Vegetarian', 'Starters', 'Desserts', 'Drinks']);
                }
                else {
                    addBotMessage("I can help you find the perfect dish! What type of food are you interested in?");
                    showSuggestions(['Vegetarian', 'Non-Vegetarian', 'Starters', 'Desserts', 'Drinks']);
                }
            }
        ...
        <div class="chatbot-container" id="chatbot">
            ...
            <div class="chat-input-container">
                <input type="text" class="chat-input" id="chat-input" placeholder="Ask me what to eat..."
